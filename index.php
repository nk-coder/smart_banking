      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Banking from anywhere and anytime.</p>
            <p><a href="account_request" class="btn btn-primary py-3 px-4">Create Account From home</a></p>
          </div>
        </div>
      </div>
    </section>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex order-md-last">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(resource/images/about.jpg);">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(resource/images/about-1.jpg);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-6 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 testimony-section">
								<div class="owl-carousel carousel-testimony">
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(resource/images/person_1.jpg);"></div>
				          			<div>
			                    ...
			                    <span class="position">Businessman</span>
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(resource/images/person_2.jpg);"></div>
				          			<div>
				          				<p class="name mb-0">Luis Fox</p>
			                    <span class="position">Businessman</span>
				          			</div>
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(resource/images/person_3.jpg);"></div>
				          			<div>
				          				<p class="name mb-0">Luis Fox</p>
			                    <span class="position">Businessman</span>
				          			</div>
    ...
    <section class="ftco-section bg-light" id="attorneys-section">
        ...
        <div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(resource/images/staff-1.jpg);"></div>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(resource/images/staff-3.jpg);"></div>
							</div>
							<div class="text d-flex align-items-center pt-3 text-center">
								<div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(resource/images/staff-4.jpg);"></div>
							</div>
							<div class="text d-flex align-items-center pt-3 text-center">
								<div>
